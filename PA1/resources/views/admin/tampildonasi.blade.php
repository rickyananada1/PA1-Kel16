                  ...
                  <div class="card-body">
                    <form action="/updatedonasi/{{ $data->id }} " method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="jenis" id="exampleInputEmail1" value="{{ $data->jenis }}" aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control"name="jumlah" value="{{ $data->jumlah }}" id="exampleInputPassword1">
                        </div>
